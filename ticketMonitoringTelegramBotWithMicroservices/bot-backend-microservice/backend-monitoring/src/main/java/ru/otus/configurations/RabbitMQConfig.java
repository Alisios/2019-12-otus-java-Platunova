...
public class RabbitMQConfig {
    ...
    public DirectExchange monitoringExchange() {
        return new DirectExchange(rabbitMQProperties.getMonitoringExchange(), true, false);
    }

    @Bean
    public Queue monitoringQueue() {
        return QueueBuilder.durable(rabbitMQProperties.getMonitoringQueue())
    ...
    public Binding monitoringBinding() {
        return BindingBuilder.bind(monitoringQueue()).to(monitoringExchange()).with(rabbitMQProperties.getMonitoringQueue());
    }
