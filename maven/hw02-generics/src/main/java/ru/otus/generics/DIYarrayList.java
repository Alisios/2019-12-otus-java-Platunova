    ...
    public DIYarrayList (Collection<? extends T> c) {
        ...
        if ((size = genericData.length) != 0) {
            if (genericData.getClass() != Object[].class)
                genericData = (T[])Arrays.copyOf(genericData, this.size);
        } else {
   ...
   @Override
    ...
    public <T> T[] toArray(T[] a) {
        if (a.length < this.size) {
           ...
           // T[] b = new Object[];
         //   return (T[]) Arrays.copyOf(genericData, this.size);
         //  T[] optional_ar = (T[]) new Object[this.size];
         //   System.arraycopy(genericData,0, optional_ar,0, this.size);
         //   return optional_ar;
        }
        else{
    ...
    public ListIterator<T> listIterator(int index) {
        return new ListIterator<>() {
            ...
            public void set(T t) {
                ...
                //genericData.set(current_index, t);
